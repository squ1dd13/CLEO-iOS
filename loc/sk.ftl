...
menu-gesture-opt-desc = Dotyková akcia potrebná na zobrazenie menu CLEO.

# A single motion where one finger moves quickly down the screen.
menu-gesture-opt-one-finger-swipe = Potiahnite jedným prstom nadol

# A single swipe (as above) but with two fingers at the same time instead of just one.
menu-gesture-opt-two-finger-swipe = Potiahnite dvoma prstami nadol

# A short tap on the screen with two fingers at once.
menu-gesture-opt-two-finger-tap = Klepnite dvoma prstami

# A short tap on the screen with three fingers at once.
menu-gesture-opt-three-finger-tap = Klepnite tromi prstami
