...
menu-script-warning-overview =
    { $numberOfScriptsWithErrors ->
        ...
        *[other] Chyby se zjistily v { $numberOfScriptsWithErrors } skriptech. Tyto skripty jsou zvýrazněny oranžově.
    }
...
cheat-menu-advice = Pokud nechcete riskovat prolomení vašeho uložení, zálohujte si svůj postup nejprve do jiného slotu.
...
cheat-hit-the-road-jack = Klást Tanker and trailer (cisternový vůz)
