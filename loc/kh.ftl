...
splash-legal = កម្មសិទ្ធបញ្ញា © 2020-2023 squ1dd13, AYZM, ODIN, RAiZOK, tharryz, wewewer1. មានអាជ្ញាប័ណ្ណក្រោមអាជ្ញាប័ណ្ណ MIT.
...
cheat-menu-advice = ប្រសិនបើអ្នកមិនចង់ប្រថុយបាត់បង់ការរក្សាទុកហ្គេមរបស់អ្នកទេសូមធ្វើការរក្សាទុកហ្គេមរបស់អ្នកទៅកាន់កន្លែងផ្ទុកផ្សេងជាមុនសិន.
