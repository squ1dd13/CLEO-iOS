...
static_assert(sizeof(TextureDatabaseEntry) == 0x1f, "bad");
...
struct TextureDatabaseRuntime {
    ...
    // Same for all databases. Given on first line of .txt file:
    //  "cat=x name=Default ..."
    // MOST LIKELY A STRUCT POINTER WITH A char * AT THE START.
    char **categoryName;
    ...
    struct TextureDatabaseEntry *entries;
