...
Script::Script(const std::string &path) {
    ...
    // TODO: Zero-initialise all members or call default constructor from game.
...
Script *Script::GetAlternateThis(uint64 handlerOffset) {
    ...
    return (Script *)((long long)&this->nextScript + (*(long long *)((long long)handlerTable + handlerOffset + 8) >> 1));
}
...
Script::OpcodeHandler Script::FindHandler(uint16 opcode, Script *&thisPtr) {
    ...
    uint64 handlerOffset = (uint64((opcode & 0x7fff) * 1374389535llu) >> 33) & 0x3ffffff0;
